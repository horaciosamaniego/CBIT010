...
## "El pudú es el ciervo más `_____` del mundo."

---

<!-- _class: pregunta -->

# Y, esta importante premisa de la conservación para la biodiversidad:

## "La Teoría de Biogeografía de Islas explica la `_____` de islas insulares y territoriales"
...
![w:300px](./figs/Perceptron_diagram.png)
...
1.Tokenización
2.Embeddings: del texto a los números
3.Atención: cada palabra mira a todas las demás
...
![w:800px](./figs/Words_embedding.png)

</div>

- [Tensor Flow](https://projector.tensorflow.org/?_gl=1*mx472k*_ga*MTgyMjkzNzAxNS4xNzc3MzIyMDE2*_ga_W0YLR4190T*czE3NzczMjIwMTYkbzEkZzAkdDE3NzczMjIwMTYkajYwJGwwJGgw) <-- pincha allí !
